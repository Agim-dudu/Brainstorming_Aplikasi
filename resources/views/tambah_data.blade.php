                ...
                <div class="card-body">
                  <form action="{{ route('admin.tambah_data.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-2">
                        ...
                        <input type="text" class="form-control @error('product_name') is-invalid @enderror" id="product_name" name="product_name" placeholder="Product Name">
                        @error('product_name')
                    ...
                    <div class="form-group mb-2">
                        ...
                        <textarea class="form-control @error('product_description') is-invalid @enderror" id="product_description" name="product_description" placeholder="Product Description" required></textarea>
                ...
                <div class="card-body">
                    <form action="{{route('register.store')}}" method="post">
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="text"
                                class="form-control @error('UsernameInput') is-invalid @enderror"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="email"
                                class="form-control @error('emailInput') is-invalid @enderror"
                        ...
                        <div class="form-group mb-2">
                            ...
                            <input type="password"
                                class="form-control @error('passwordInput') is-invalid @enderror"
