...
<body>
    ...
    <div class="container-fluid my-2 mb-4">
        <img src="{{ asset('fg.png')}}" class="img-fluid" alt="...">
    </div>
    <div class="container-fluid text-center bg-info mb-4">
        <div class="row">
            <div class="col">
                <h2>Selamat Datang di Toko AMC Tech</h2>
            ...
            <div class="col">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu w-25">
                        ...
                        <div class="row p-3">
                            <div class="col-4 ">
                                <img src="{{ asset('storage/images/product/')}}/{{ $details['photo'] }}"
                                    class="img-fluid">
                            </div>
                            <div class="col-8">
